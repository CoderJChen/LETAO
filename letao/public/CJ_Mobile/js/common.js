 ...
 * 常用链接
 * */
LeTao.LOGIN_URL = '/CJ_Mobile/user/login.html';
LeTao.SEARCH_LIST_URL = '/CJ_Mobile/searchList.html';
LeTao.CART_URL = '/CJ_Mobile/cart.html';
LeTao.USER_URL = '/CJ_Mobile/user/';
